...
export const updateUsuario = async (req, res) => {
   try {
    const {id} = req.params;
    const {nombre_persona, apellido_persona, dni_persona, fecha_nac_persona, telefono_persona, username_usuario, password_usuario} = req.body
    console.log(id)
    const updateUser = await Usuario.findOne({where: {id_usuario : id}})
